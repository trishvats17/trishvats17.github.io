      ...
      <main className="bg-yellow-600 font-poppins">
           ...
           <Nav acolor='text-black' wcolor='text-white' kcolor='text-black' ccolor='text-black'/>
            ...
            <div className='lg:w-50'>
                <div className='flex'>
                <img src={i.worklogo} width={50} height={50}/>
                ...
                <img src={i.authorlogo} width={40} height={40}/>
                ...
                <div className='bg-yellow-600 lg:pt-12 lg:flex lg:visible hidden'>
                <img src='div.svg'/>
                </div>
            </div>
            ...
            <div className='lg:w-90 lg:pl-10 lg:pt-4 pt-4'>
                <div>
                  <img src={i.image} width={4000} height={2000} className="rounded-lg" />
                </div>
                <div className='lg:pt-5 pt-4 lg:flex lg:justify-between'>
                  <div className='lg:justify-between'>
                    <div className='flex'>
                      <img src={i.rolelogo} width={40} height={40}/>
                    ...
                    <div className='flex pt-2'>
                      <img src={i.projectlogo} width={40} height={40}/>
                  ...
                  <div className='lg:text-end lg:w-36 flex flex-row lg:flex-col lg:pt-0 pt-10 justify-center'>
                    <div className='lg:pb-2 pb-20'>
                      <a href={i.button1link}><button className="p-2 mr-2 md:mr-0 rounded-full bg-white hover:bg-black hover:text-white text-sm "><b>{i.button1name}</b></button></a>
                    </div>
                    <div>
                      <a href={i.button2link}><button className={`${i.button2Visible} p-2 ml-2 lg:ml-0 rounded-full bg-white hover:bg-black hover:text-white text-sm`}><b>{i.button2name}</b></button></a> 
                    </div>
                  </div>
                </div> 
            </div>
